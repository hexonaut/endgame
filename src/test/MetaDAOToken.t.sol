...
import { MetaDAOToken } from "../MetaDAOToken.sol";

contract MetaDAOTokenTest is DSSTest {
    ...
    function postSetup() internal virtual override {
        ...
        token = new MetaDAOToken();
    }

    function testAuth() public {
        checkAuth(address(token), "MetaDAOToken");
    }

    function invariantMetadata() public {
        assertEq(token.name(), "MetaDAO Token");
        assertEq(token.symbol(), "MDAO");
    ...
    function testMintBadAddress() public {
        vm.expectRevert("MetaDAOToken/invalid-address");
    ...
    function testDecreaseAllowanceInsufficientBalance() public {
        assertTrue(token.increaseAllowance(address(0xBEEF), 1e18));
        vm.expectRevert("MetaDAOToken/insufficient-allowance");
    ...
    function testTransferInsufficientBalance() public {
        ...
        vm.expectRevert("MetaDAOToken/insufficient-balance");
    ...
    function testPermitBadNonce() public {
        ...
        vm.expectRevert("MetaDAOToken/invalid-permit");
        token.permit(owner, address(0xCAFE), 1e18, block.timestamp, v, r, s);
    }
    ...
    function testPermitPastDeadline() public {
        ...
        vm.expectRevert("MetaDAOToken/permit-expired");
